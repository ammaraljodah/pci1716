...
typedef struct {
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_m;                 /* '<S2>/S-Function' */

  int_T SFunction_IWORK_i;             /* '<Root>/S-Function' */
} DW_driver_test_T;
...
struct P_driver_test_T_ {
  real_T SFunction_P1_Size[2];         /* Computed Parameter: SFunction_P1_Size
                                        ...
                                        */
  real_T SFunction_P1[6];              /* Expression: [0 1 2 3 4 5]
                                        * Referenced by: '<Root>/S-Function'
                                        */
  real_T SFunction_P2_Size[2];         /* Computed Parameter: SFunction_P2_Size
                                        * Referenced by: '<Root>/S-Function'
                                        */
  real_T SFunction_P2[5];              /* Expression: [-10 -10 -10 -10 -10]
                                        * Referenced by: '<Root>/S-Function'
                                        */
  real_T SFunction_P3_Size[2];         /* Computed Parameter: SFunction_P3_Size
                                        * Referenced by: '<Root>/S-Function'
                                        */
  real_T SFunction_P3;                 /* Expression: 0.0004
                                        * Referenced by: '<Root>/S-Function'
                                        */
  ...
  real_T SFunction_P5_Size[2];         /* Computed Parameter: SFunction_P5_Size
                                        * Referenced by: '<Root>/S-Function'
                                        */
  real_T SFunction_P5;                 /* Expression: 5
                                        * Referenced by: '<Root>/S-Function'
                                        */
};
 ...
 *
 * '<Root>' : 'driver_test'
 * '<S1>'   : 'driver_test/Scope '
 * '<S2>'   : 'driver_test/Scope 2'
 */
